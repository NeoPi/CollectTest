package cn.com.byg.collecttest.widget;
...
public class CircleProgressBar extends View{
    ...
    public CircleProgressBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        roundProgressColor = mTypedArray.getColor(R.styleable.CircleProgressBar_circleBarColor, Color.GREEN);
        ...
        textIsDisplayable = mTypedArray.getBoolean(R.styleable.CircleProgressBar_textIsShow, true);
